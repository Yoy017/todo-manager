...
public class TaskManager {
    ...
    public static class CreateTask implements Callable<Integer> {
        ...
        public Integer call() {
            ...
            try{
                ...
                System.out.println("You can only create tasks in an existing List.");
            }
            return 0;
        }
    }
    ...
    public static class ShowTasks implements Callable<Integer> {
        ...
        public Integer call() {
            ...
            try{
                ...
                System.out.println("You can only show tasks in an existing List.");
                return 1;
            }
    ...
    public static class updateTask implements Callable<Integer> {
        ...
        public Integer call() {
            ...
            try{
                ...
                System.err.println("You can only update tasks in an existing List.");
                return 1;
            }
    ...
    // Sous-commande pour afficher toutes les listes
    @CommandLine.Command(name = "showList", description = "Show all lists")
    public static class ShowList implements Callable<Integer> {
